...
<html lang="en">
    <head>
        ...
        <title>KONFIRMASI PEMBATALAN RESERVASI - SANDYAKALA</title>
        <style>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless">
                        <tr>
                            <td colspan="2">
                                <center>
                                    <a href="deleteReq.php?id=<?=$id?>" class="btn btn-primary">Tolak Pembatalan</a>
                                    <a href="konfirmasiCancel.php?id=<?=$id?>" class="btn btn-primary">Terima Pembatalan</a>
                                </center>
                            </td>
                        </tr>
                    </table>
